...
public class WordGramTester {
	...
	public void testToString(){
		...
		assertEquals("toString test for a",a.toString().equals("apple zebra mongoose hat"), true);
		assertEquals("toString test for b",b.toString().equals("zebra mongoose hat"), true);
		assertEquals("toString test for a",b.toString().equals(c.toString()), true);
		assertEquals("toString test for b",d.toString().equals("zebra"), true);
	}
	...
	public void testShiftAdd() {
		...
		WordGram a = new WordGram(words,0,4);
		WordGram b = new WordGram(words,1,4);
		WordGram apotato = a.shiftAdd("potato");
		WordGram c = b;
		WordGram d = apotato.shiftAdd("! hi there !");
		
		assertEquals("shift add apotato and b", apotato.equals(b),false);
		assertEquals("shift add c and b", c.equals(b),true);
		assertEquals("shift add apotato and string", apotato.toString().equals("zebra mongoose hat potato"),true);
		assertEquals("shift add d and string ", d.toString().equals("mongoose hat potato ! hi there !"),true);
	}
